...
import com.protfolio.pm.project_manager_api.core.model.utils.ProjectAssembler;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    public List<ProjectsReturn> getAllProjects() {
        try {
            ...
            throw new ProjectRepositoryException("Database error while retrieving projects", ex);
        }
    }
    ...
    public ProjectsReturn getProjectById(Long id) {
        ...
        try {
            ...
            throw new ProjectRepositoryException("Database error while retrieving project by ID", ex);
        }
    }
    ...
    public CreateProjectResponse insertProject(CreateProjectBody body) {
        try {
            Client client = clientRepository.findById(body.clientId())
                    .orElseThrow(() -> new ProjectNotFoundException("Client not found with ID: " + body.clientId()));
            ...
            throw new ProjectRepositoryException("Database error while saving project", ex);
        }
    }
}
